...
#jigsaw gridded .msh format Distance to taget poings
DistanceToCoastFile="/scratch3/NCEPDEV/climate/Keston.Smith/RWPS/Data/JigsawFormatFiles/DistToUScoast_shifted.OSMxGSHHS.Boxes.msh"
#jigsaw gridded .msh format topography on same grid as distance
TopographyFile="/scratch3/NCEPDEV/climate/Keston.Smith/RWPS/Data/JigsawFormatFiles/Topo_shifted.OSMxGSHHS.Boxes.msh"

# directory to write output files to
OutDir='RWPS.OSMxGSHHS.NewOrl/'

ww3_mesh_file='RWPS.GSHHSxGSHHS.NewOrl.WW3.msh'
