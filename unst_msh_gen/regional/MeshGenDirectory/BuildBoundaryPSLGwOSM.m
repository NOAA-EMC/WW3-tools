% Script to build PSLG based on Open Street Map(OSM) ocastline database
% https://osmdata.openstreetmap.de/download/land-polygons-complete-4326.zip
% Before running this script run script MakeCoastalBoundariesOSM.m to smooth curves in GSHHS data to reflect 
