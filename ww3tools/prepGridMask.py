...
USAGE:
 ...
 The file distFromCoast.nc was generated by organizeDistanceToCoast.py
  and, if now downloaded during ww3-tools installation, you can find it at:
...
outpath='/work/noaa/marine/ricardo.campos/work/analysis/HR1'
# -----------------
if fainfo>=1:
...
ds=xr.open_dataset('gfs.20191203.t00z.global.0p25.nc')
