# Script to take altimeter tracks and collocate into regulat lat/lon grid (gridInfo.nc, generated by preprGridMask.py)
# It runs one satellite mission, entered as argument (only the ID, sys.argv), see the sdname for the list of altimeters available.
# An example of JASON3 is
#   nohup python3 gridSatGlobal_Altimeter.py 0 >> nohup_sat0.txt 2>&1 &
# See the pre-selected parameters below for the altimeter collocation, path, and date interval
