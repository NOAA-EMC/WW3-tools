...
BASE_MODEL_DATA_DIR="/work/noaa/marine/jmeixner/Data/HR2/winter/"
FILE_FORMAT="grib2"
MODEL="HR2"

# Define start and end datetime for processing
start_datetime="2019120300" 
end_datetime="2019120600"  
...
while [ $current_timestamp -le $end_timestamp ]; do
    ...
    satellite_file="./Altimeter_CRYOSAT2_HRwinter.nc"
    ...
    if [ ${#model_data_files[@]} -gt 0 ]; then
        ...
        OUTPUT_FILE="./WW3-Altimeter_winter${MODEL}ainterpolated${current_datetime}.nc"
