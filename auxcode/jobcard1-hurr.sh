...
BASE_MODEL_DATA_DIR="/work/noaa/marine/jmeixner/Data/HR2/hurricane/"
FILE_FORMAT="grib2"
MODEL="HR2"

# Define start and end datetime for processing
start_datetime="2020072000" 
end_datetime="2020072600"  
...
while [ $current_timestamp -le $end_timestamp ]; do
    ...
    satellite_file="./Altimeter_CRYOSAT2_HRhurricane.nc"
    ...
    if [ ${#model_data_files[@]} -gt 0 ]; then
        ...
        OUTPUT_FILE="./WW3-Altimeter_hurricane${MODEL}ainterpolated${current_datetime}.nc"
